    ...
    <div className="relative w-full max-w-xs mx-auto">
      <div className="relative">
        <svg viewBox="0 0 200 120" className="w-full">
          ...
          {/* Needle pivot */}
          <circle cx="100" cy="100" r="10" fill="#011c40" stroke="#ffffff" strokeWidth="2" />
        </svg>

        {/* BMI value badge */}
        <div className="absolute left-1/2 top-[74%] -translate-x-1/2 rounded-md border border-[#54acbf]/30 bg-white/95 px-3 py-1 text-2xl font-bold text-[#023859] shadow-sm">
          {value.toFixed(1)}
        </div>
      </div>
